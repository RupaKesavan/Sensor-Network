function[Clus_Pos,Link_Q,Er]=OOA(nPop,data,lowerbound,upperbound,dimension,Max_iterations,ClusterMembers,E0,fitness,ES)

lowerbound=ones(1,dimension).*(lowerbound);                              % Lower limit for variables
upperbound=ones(1,dimension).*(upperbound);                              % Upper limit for variables
SearchAgents=nPop;                                                       % population members 
...
for i=1:nPop   
     PopPos=ClusterMembers{i};        
     [Clus_Pos,Link_Q,Er]=BenFunctions(nPop,data,ClusterMembers,E0,Trans,Tm,Tmx,ES); % call the BenFuctions              
end
Best_score=fbest;
Best_pos=xbest;
